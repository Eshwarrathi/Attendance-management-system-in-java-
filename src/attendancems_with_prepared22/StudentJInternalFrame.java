...
public class StudentJInternalFrame extends javax.swing.JInternalFrame {
    ...
    private void AttendanceButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AttendanceButtonActionPerformed
        ...
        try {
            ...
            PreparedStatement pst = c.xc.prepareStatement("insert into std_attend values(?,?,?,?,?,?,?)");
            pst.setString(1 , d);
            pst.setString(2, jLabel11Std_id.getText());
                    
                    
            pst.setString(3, jComboBox1Name.getSelectedItem().toString());
            pst.setString(4, jLabel9Std_batch.getText());
            pst.setString(5, jComboBox2Book.getSelectedItem().toString());
            pst.setString(6, jComboBox3Session.getSelectedItem().toString());
